...
//  print_r($ini_array);
  ...
  if ( isset($_POST['submit']) || isset($_POST['audiosettings_submit']) )
  {
    ...
    // Sync all player config values for:
    // * MS / non-MS coding
    // * BF / BFMS
    ...
    $_POST['JACKMS_BLUEALSAAPLAY'] = $_POST['JACK_BLUEALSAAPLAY'];
    $_POST['JACKMS_INPUT'] = $_POST['JACK_INPUT'];
    ...
    $_POST['JACKBF_BLUEALSAAPLAY'] = $_POST['JACK_BLUEALSAAPLAY'];
    $_POST['JACKBF_INPUT'] = $_POST['JACK_INPUT'];
    ...
    $_POST['JACKBFMS_BLUEALSAAPLAY'] = $_POST['JACK_BLUEALSAAPLAY'];
    $_POST['JACKBFMS_INPUT'] = $_POST['JACK_INPUT'];
    $_POST['JACKBFMS_NETJACK'] = $_POST['JACK_NETJACK'];

    // Set values to "OFF" if device test fails
    if ($_POST['JACK_INPUT'] == "")
    {
      $_POST['JACK_INPUT'] = "OFF";
